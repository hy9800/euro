  ...
  return (
    ...
    >
      ...
      <meta
        ...
        content="Leading professional training institution offering 1000+ courses worldwide"
      />
      ...
      <Container className="h-full min-h-[calc(100vh-160px)] flex flex-col items-center justify-center gap-5 text-center static">
        <header className="max-w-full w-full">
          {/* Hero Title */}
          <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-2 leading-tight max-w-5xl mx-auto animate-slide-up">
            Join
          ...
          <p
            itemProp="description"
            className="text-gray-600 mx-auto mb-2 text-base md:text-lg leading-relaxed max-w-4xl animate-fade-in-delay opacity-0 transform translate-y-5"
          >
      ...
      <a
        href="#about"
        className="absolute bottom-0 left-1/2 transform flex flex-col items-center gap-2 cursor-pointer z-20 animate-scroll-bounce"
        aria-label="Scroll down to explore more content"
      >
        <span className="text-[#3E5EC0] font-medium text-xs uppercase tracking-wide transition-all duration-300 hover:text-blue-700">
          Explore More
        </span>
        <span className="text-[#3E5EC0] text-xs transition-all duration-300 hover:text-blue-700 hover:translate-y-1 animate-arrow-bounce">
